...
public class StringNode {
    ...
    public static StringNode copy(StringNode str) {
        ...
        StringNode prev = copy; 
        StringNode next;

        while (str.next != null) //don't go out of bounds NOT FOR LOOP
        {  
            next = new StringNode(str.next.ch, null);
            prev.next = next;
            prev = next;
            //go to next letter
            str = str.next; 
    ...
    {
    if (str == null) 
    {          // base case 1: ch wasn't found
        return -1;
    } else if (str.ch == ch) 
    {  // base case 2: ch was just found
        return 0;           
    } else
        {
            StringNode str1 = str;
     ...
     */
    public static StringNode insertAfter(StringNode str, char newChar, char afterChar) 
    {
    ...
    public static StringNode removeAllSpaces(StringNode str) {
        ...
        else 
        {
            ...
            for(int i = 0; i < length(str); i++)
            {
                ...
                if(current.next != null) //no errors
                {
                    current = current.next; //keep list moving
                }
            }
