 ...
 * 
 * 
 * *** Your solution for PS 4 should NOT go in this file. ***
...
public class Sort {
    ...
    private static void merge(int[] arr, int[] temp, 
      int leftStart, int leftEnd, int rightStart, int rightEnd)                            //makes another array
    {
    ...
    private static void mSort(int[] arr, int[] temp, int start, int end) {                             //makes another array
        if (start >= end) {
            return;
        }
    ...
    /** mergesort */
    public static void mergeSort(int[] arr) {                                                          //makes another array
